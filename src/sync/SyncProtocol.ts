...
export type SyncMessage =
  | { type: 'symbol';      seq: number; symbol: string }
  | { type: 'resolution';  seq: number; resolution: Resolution }
  | { type: 'chartType';   seq: number; chartType: ChartType }
  | { type: 'viewport';    seq: number; fromIndex: number; toIndex: number }
