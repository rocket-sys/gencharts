...
export interface Indicator {
     ...
     */
    draw(ctx: CanvasRenderingContext2D, fromIdx: number, toIdx: number, chartW: number, paneHeight: number, timeScale: TimeScale, priceScale: PriceScale, theme: Theme): void;
